...
.PARAMETER Clean
Removes the image fizzbuzzapp and kills all containers based on that image.
...
Build a Docker image named fizzbuzzapp
#>
...
$imageName="fizzbuzzapp"
$projectName="fizzbuzzapp"
$serviceName="fizzbuzzapp"
